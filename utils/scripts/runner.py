...
parser.add_argument("-PrintParams", help="Print Params", type=int)
parser.add_argument("-ParamSource", help="Param Source")
...
print(f"{score}, {score/foodCount}, {getattr(args, 'ParamSource')}, {getattr(args, 'FoodDistribution')}")
f = open(f"/scripts/score_{int(time.time())}.txt", "w")
f.write("{}\n".format(str(score)))
